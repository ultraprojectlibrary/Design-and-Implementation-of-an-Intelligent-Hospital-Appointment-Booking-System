import re
filepath = r'c:\Users\jepht\Music\rojex_projects\hospital_booking\templates\doctors\appointments.html'
with open(filepath, 'r', encoding='utf-8') as f:
    content = f.read()

# Add badge
pattern = re.compile(r'(<form action="{% url \'update_appointment_status\' appt\.id %}" method="post">)')
...
with open(filepath, 'w', encoding='utf-8') as f:
    f.write(content)
print('Updated doctor appointments page')
